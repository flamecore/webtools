...
class UserAgentStringParserTest extends \PHPUnit_Framework_TestCase
{
    public function testParserWithDesktopBrowsers()
    {
        $testData = array(
            ...
            => array('edge', '12.0', 'Windows 10', 'webkit'),
            ...
            => array('yabrowser', '13.12', 'Windows 7', 'webkit'),

            // Maxthon 3.0
            'Mozilla/5.0 (Windows; U; Windows NT 6.0; en-US) AppleWebKit/533.1 (KHTML, like Gecko) Maxthon/3.0.8.2 Safari/533.1'
            => array('maxthon', '3.0', 'Windows Vista', 'webkit'),
            ...
            => array('maxthon', '2.0', 'Windows 7', 'trident'),
    ...
    public function testParserWithMobileBrowsers()
    {
        $testData = array(
            ...
            => array('safari', '5.0', 'iPhone', 'webkit'),
